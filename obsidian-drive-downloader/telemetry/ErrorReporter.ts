...
export class ErrorReporter {
	...
	constructor(private settings: DriveDownloaderSettings, private version: string) {}

	updateSettings(settings: DriveDownloaderSettings): void { this.settings = settings; }
	...
	private isOurs(err: unknown): boolean {
		...
		return /drive-downloader|drive-sync/i.test(stack);
	}
