...
export class ChangelogModal extends Modal {
	...
	onOpen(): void {
		...
		contentEl.createEl("h3", { text: `What's new in Drive Downloader ${this.currentVersion}` });
		...
		new Setting(contentEl)
			.addButton((b) =>
				b.setButtonText("View releases on GitHub").onClick(() => {
					window.open("https://github.com/connradolisboa/drive-folder-sync/releases", "_blank");
				})
			)
			.addButton((b) =>
